...
```
cd existing_repo
git remote add origin https://gitlab.com/fkonkowski/smart-gym-counter.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/fkonkowski/smart-gym-counter/-/settings/integrations)
